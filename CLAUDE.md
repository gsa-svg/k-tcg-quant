...
> 2. **애드센스**: 7/30 재심사 신청함(사유: "가치 없는 콘텐츠"). 결과 확인해서 사용자에게 알릴 것.
>    - 승인되면 → `HANDOFF.md`의 "애드센스 심사용 임시조치" 섹션대로 noindex 48장(카드27+ko21) 해제.
>      그게 지금 유입을 막는 가장 큰 단일 요인이다(색인 56장 → 104장).
...
1. **Google AdSense**: 코드 배포됨(`ca-pub-1520891018658006`), `ads.txt` 있음. **2026-07-30 재심사 신청(1차 반려: 가치 없는 콘텐츠)** — 매번 확인해서 승인됐으면 알려주고, 거절되면 사유 확인 후 콘텐츠 보강.
