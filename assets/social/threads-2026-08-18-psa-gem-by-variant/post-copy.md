...
**반드시 gemrate.com 페이지 위에서 실행해야 한다.** 다른 오리진(eBay 탭 등)에서 fetch 하면
교차 출처로 막혀 전부 FAIL 이 난다 — 2026-08-18 에 이걸 "요청 한도"로 오진해 영문 7세트를
포기할 뻔했다. 같은 오리진으로 옮기니 7/7 이 한 번에 들어왔다.
